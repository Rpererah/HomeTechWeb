      ...
      <div class="container">
        <div class="row">
          <div class="col-12 mb-5 position-relative">
            <h2 class="section-title text-center mb-5" data-aos="fade-up" data-aos-delay="">Nossa Equipe</h2>
            <p class="lead text-center mb-5" data-aos="fade-up" data-aos-delay="100">Aqui você vê nossa equipe e descobre como contactar a cada um</p>
          </div>
        </div>
        <div class="row" style="justify-content: center; align-items: center;">
          ...
          <div class="col-md-6 col-lg-3 mb-4" data-aos="fade-up" data-aos-delay="200">
            <div class="team-member">
              ...
              <div class="p-3">
                <h3>Pedro Costa</h3>
                <span class="position"><b>Programador FrontEnd</b></span>
              </div>
            </div>
          </div>
          <div class="col-md-6 col-lg-3 mb-4" data-aos="fade-up" data-aos-delay="300">
            <div class="team-member">
              ...
              <div class="p-3">
                ...
                <span class="position"><b>Programador BackEnd</b></span>
              </div>
            </div>
          </div>
