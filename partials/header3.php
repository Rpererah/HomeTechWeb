...
<html lang="en">
  ...
  <div class="site-wrap">
    ...
    <div class="site-blocks-cover overlay bg-light" style="background-image: url('images/backservicos.png'); " id="home-section">
      ...
      <div class="container">
        <div class="row justify-content-center">
          ...
          <div class="col-12 text-center align-self-center text-intro">
            <div class="row justify-content-center">
              <div class="col-lg-8">
                <h1 class="text-white" data-aos="fade-up" data-aos-delay="">Veja os nossos serviços</h1>
                <p class="lead text-white" data-aos="fade-up" data-aos-delay="100">a um toque de distância</p>
                <p data-aos="fade-up" data-aos-delay="200"><a href="#services-section" class="btn smoothscroll btn-primary">Clique aqui</a></p>
